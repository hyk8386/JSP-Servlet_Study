...
<body>
	<form method="get" action="RadioServlet">
		...
		<input type="radio" id="gerder" name="gender" value="남자" checked>남자
		<input type="radio" id="gerder" name="gender" value="여자">여자<br><br>
		...
		<label for="content">간단한 가입 입사를 적어주세요 ^ㅇ^</label>
